...
public class APIController implements TokenCallBack{
	...
	public  void invokeAPI(APIUtilities apiUtilities, APIResultCallBack apiResultCallBack,int requestCode, Context context){
		...
		try {
	        IdentityProxy.getInstance().getToken(IdentityProxy.getInstance().getContext(),this,APIController.clientKey,APIController.clientSecret);
...
//	 private class NetworkCallRefresh extends AsyncTask<APIUtilities, Void, Map<String,String>> {
//		 	APIResultCallBack apiResultCallBack;
//	        public NetworkCallRefresh(APIResultCallBack apiResultCallBack) {
//	        	this.apiResultCallBack = apiResultCallBack;
//	        }
//
//	        @Override
